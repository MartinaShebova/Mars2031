 ...
 * @ORM\Entity(repositoryClass="MarsGameBundle\Repository\BuildingCostResourceRepository")
 */
class BuildingCostResource
{
     ...
     * @var Building
     *
     * @ORM\ManyToOne(targetEntity="MarsGameBundle\Entity\Building", inversedBy="costs")
     ...
     * @var GameResource
     *
     * @ORM\ManyToOne(targetEntity="MarsGameBundle\Entity\GameResource", inversedBy="buildingCosts")
